...
class FileStorage implements IStorage {
  ...
  async createPartner(data: InsertPartner): Promise<Partner> {
    ...
    const partner: Partner = {
      ...
      secondaryButtonBgColor: data.secondaryButtonBgColor ?? "transparent",
      secondaryButtonTextColor: data.secondaryButtonTextColor ?? "#000000",
      secondaryButtonBorder: data.secondaryButtonBorder ?? "1px solid #0f0f0f",
      logoColor: data.logoColor ?? null,
      headerBgColor: data.headerBgColor ?? "#ffffff",
      headerBgImage: data.headerBgImage ?? null,
      headerLogoHeight: data.headerLogoHeight ?? "18px",
      ...
      declineButtonText: data.declineButtonText ?? "Decline offer",
